...
namespace eyewear_store_management_system.CustomComponents
{
    public class CustomDatePicker: DateTimePicker
    {
        ...
        protected override void OnEnabledChanged(EventArgs e)
        {
            ...
            if (!this.Enabled)
            {
                this.TextColor = Color.Silver;  // Chữ màu bạc
                this.calendarIcon = UtilityImage.AdjustImage(Properties.Resources.calendarDark, exposure: 0.5f);
            }
            else
            {
                this.TextColor = Color.Black;
                this.calendarIcon = Properties.Resources.calendarDark;
            }
